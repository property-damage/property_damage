defmodule PropertyDamage.PersistenceTest do
  ...
  alias PropertyDamage.{Failure, FailureReport, Persistence, RunTrace, Sequence}
  ...
  describe "save and load round-trip" do
    ...
    test "saves and loads a report round-trip", %{tmp_dir: dir} do
      ...
      assert FailureReport.failure_type(loaded) == FailureReport.failure_type(report)
      assert FailureReport.check_name(loaded) == FailureReport.check_name(report)
    end
